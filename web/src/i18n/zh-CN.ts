...
export const zhCN: Translations = {
  ...
  errors: {
    ...
    unsupportedUrl: '目前仅支持 QQ 音乐公开歌单链接（例如 https://y.qq.com/n/ryqq/playlist/xxxxxx）或纯数字 ID。',
    playlistNotFound: '未找到该歌单，可能已被作者删除、设置为私密或当前不可访问。',
    incompletePlaylist: '歌单数据获取不完整（QQ 音乐服务器返回数据缺失）。PlaylistOut 遵循严格完整性保障，已中止解析，避免导出不全。',
    upstreamTimeout: '连接 QQ 音乐服务器超时，请检查网络或稍后重试。',
    upstreamError: 'QQ 音乐服务响应异常，请稍后重试。',
  ...
  stats: {
    ...
    otherPlatformsComing: '网易云、酷狗与酷我音乐筹备中...',
