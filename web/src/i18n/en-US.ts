...
export const enUS: Translations = {
  ...
  search: {
    ...
    placeholder: 'Paste a public playlist link (QQ Music / NetEase / KuGou) or ID / User ID',
  ...
  errors: {
    ...
    unsupportedUrl: 'Currently supports public playlist links, user profiles, or numeric IDs from QQ Music, NetEase Cloud Music, and KuGou Music.',
