...
export const enUS: Translations = {
  ...
  privacy: {
    ...
    section4Title: '4. Analytics, Clarity & Cookie Controls',
    section4Content: '1. In-House Analytics (Worker / D1): Designed for anonymity. We do not persist raw IP addresses, set tracking cookies, create cross-day device fingerprints, or store user accounts or playlist/song content; only coarse aggregate counters are recorded.\n\n2. Microsoft Clarity: Clarity is loaded only after you explicitly allow experience analytics. PlaylistOut uses Consent V2 with analytics_Storage granted while ad_Storage always remains denied. Clarity may use analytics cookies or pseudonymous identifiers to connect page views and sessions, and may process coarse IP-derived network/geographic information plus interaction telemetry.\n\n3. Data Boundary: PlaylistOut does not actively send playlist links, playlist IDs, song/artist names, or authorization credentials through Clarity custom events, tags, or the identify API. Inputs, playlist summaries, track lists, and auth dialogs are masked for Clarity. As a third-party service, Microsoft Clarity may still process page URLs, referrers, basic network information, and interaction data according to its service behavior. Your choice is stored only in localStorage on this device and can be changed here at any time; after declining, Clarity is not loaded on subsequent pages.',
    ...
    consentBannerTitle: 'Experience Analytics & Cookies',
    consentBannerContent: 'PlaylistOut\'s own analytics uses no tracking cookies. Microsoft Clarity uses analytics cookies only after you allow it for heatmaps, session replay, and UX improvement; advertising storage always stays off.',
    consentPreferenceTitle: 'Microsoft Clarity preference',
    consentStatusGranted: 'Current: experience analytics cookies are allowed.',
    consentStatusDenied: 'Current: experience analytics cookies are not used.',
    consentStatusUnset: 'Current: no choice has been made yet.',
    consentAllow: 'Allow experience analytics',
    consentDecline: 'No analytics cookies',
