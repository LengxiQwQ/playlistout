...
[![Release: v1.0.0](https://img.shields.io/badge/Release-v1.0.0-green.svg)](https://github.com/LengxiQwQ/playlistout/releases)
...
| **安全与滥用防护** | 出站严格域名白名单、禁止任意代理、无状态限流（30 次/分钟）、OWASP 安全标头防护 |
