...
| :---: | :---: | :---: | :---: | :---: | :---: |
| **97**<br><sub>今日独立 +9</sub> | **211**<br><sub>今日 +12</sub> | **284**<br><sub>今日 +23</sub> | **48,271**<br><sub>今日 +5,489</sub> | **47**<br><sub>今日 +11</sub> | **12 天**<br><sub>上线于 2026-09-12</sub> |

#### 📊 业务转化与平台偏好
- **🎵 平台解析份额：** QQ 音乐 **73%** (208 次) ｜ 网易云音乐 **11%** (32 次) ｜ 酷狗音乐 **13%** (37 次) ｜ 汽水音乐 **2%** (7 次)
- **📦 导出格式偏好：** Excel 表格 (.xlsx) **49%** ｜ TXT 纯文本 **15%** ｜ CSV 表格 **17%** ｜ JSON 数据 **19%**
...
> 数据开始：2026-09-07 · 最后更新：2026-09-23
<!-- INSIGHTS:END -->
