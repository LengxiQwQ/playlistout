...
| :---: | :---: | :---: | :---: | :---: | :---: |
| **130**<br><sub>今日独立 +19</sub> | **266**<br><sub>今日 +20</sub> | **313**<br><sub>今日 +18</sub> | **54,208**<br><sub>今日 +2,364</sub> | **73**<br><sub>今日 +21</sub> | **13 天**<br><sub>上线于 2026-09-12</sub> |

#### 📊 业务转化与平台偏好
- **🎵 平台解析份额：** QQ 音乐 **72%** (226 次) ｜ 网易云音乐 **12%** (37 次) ｜ 酷狗音乐 **14%** (43 次) ｜ 汽水音乐 **2%** (7 次)
- **📦 导出格式偏好：** Excel 表格 (.xlsx) **44%** ｜ TXT 纯文本 **19%** ｜ CSV 表格 **16%** ｜ JSON 数据 **21%**
...
访问次数：**553** ｜ 不重复访客：**141**（近 14 天） ｜ 仓库克隆：**2,095** ｜ 不重复克隆：**400**（近 14 天）
...
> 数据开始：2026-09-07 · 最后更新：2026-09-24
<!-- INSIGHTS:END -->
