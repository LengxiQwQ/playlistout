...
1. **粘贴歌单** — 支持 QQ 音乐、网易云音乐、酷狗音乐等平台链接（网页链接、手机短链、纯歌单 ID 或带有文字的 App 分享内容，系统自动提取）。输入用户主页链接或数字 ID 亦可直接加载该用户的所有公开歌单合集。
...
### 🔗 跨平台公开歌单极速解析与导出
原生支持 **QQ 音乐**、**网易云音乐** 与 **酷狗音乐** 公开歌单：
- **QQ 音乐 / 网易云音乐**：纯网页免登录直解，无需输入 Cookie 或授权 Token，即可一键解析并无损全量导出整张歌单。
- **酷狗音乐**：免登录快速获取公开前排曲目预览；如需导出超长完整歌单，支持通过酷狗手机 App 扫码安全授权，无限制解锁全量曲目（授权凭证仅保存在本地浏览器中，绝不上报服务器）。
...
| `platform` | `string` | **必填** | 来源平台标识（例如 `"qqmusic"`、`"netease"`、`"kugou"`） |
...
| :---: | :---: | :---: | :---: | :---: | :---: |
| **132**<br><sub>今日 +18</sub> | **779**<br><sub>今日 +52</sub> | **104**<br><sub>今日 +11</sub> | **29,918**<br><sub>今日 +2,620</sub> | **217**<br><sub>今日 +19</sub> | **5 天**<br><sub>上线于 2026-09-12</sub> |

#### 🗺️ 访客地理归属与设备分布
- **🌍 主要地区来源：** 🌐 MY **50%** ｜ 🇨🇳 中国大陆 **21%** ｜ 🇺🇸 美国 **16%** ｜ 🇨🇦 加拿大 **7%** ｜ 🇨🇳 中国台湾 **6%**
- **💻 访问设备类型：** 桌面电脑 **92%** ｜ 移动手机 **8%**
- **🌐 主流浏览器：** Chrome **44%** ｜ Edge **35%** ｜ 其他浏览器 **19%** ｜ Safari **3%**
...
#### 📊 业务转化与平台偏好
- **🎵 平台解析份额：** QQ 音乐 **2%** (101 次) ｜ 网易云音乐 **98%** (5,423 次)
- **📦 导出格式偏好：** Excel 表格 (.xlsx) **63%** ｜ TXT 纯文本 **33%** ｜ CSV 表格 **2%** ｜ JSON 数据 **2%**
...
访问次数：**463** ｜ 不重复访客：**109**（近 14 天） ｜ 仓库克隆：**900** ｜ 不重复克隆：**205**（近 14 天）
