...
| :---: | :---: | :---: | :---: | :---: | :---: |
| **236**<br><sub>今日 +30</sub> | **1,576**<br><sub>今日 +190</sub> | **149**<br><sub>今日 +6</sub> | **45,515**<br><sub>今日 +2,606</sub> | **406**<br><sub>今日 +43</sub> | **6 天**<br><sub>上线于 2026-09-12</sub> |
...
#### 📊 业务转化与平台偏好
- **🎵 平台解析份额：** QQ 音乐 **93%** (120 次) ｜ 网易云音乐 **7%** (9 次)
- **📦 导出格式偏好：** Excel 表格 (.xlsx) **64%** ｜ TXT 纯文本 **32%** ｜ CSV 表格 **2%** ｜ JSON 数据 **2%**
...
访问次数：**504** ｜ 不重复访客：**113**（近 14 天） ｜ 仓库克隆：**1,128** ｜ 不重复克隆：**236**（近 14 天）
...
> 数据开始：2026-08-31 · 最后更新：2026-09-17
<!-- INSIGHTS:END -->
