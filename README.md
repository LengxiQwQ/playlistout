...
| :---: | :---: | :---: | :---: | :---: | :---: |
| **68**<br><sub>今日独立 +8</sub> | **173**<br><sub>今日 +15</sub> | **117**<br><sub>今日 +29</sub> | **29,236**<br><sub>今日 +4,530</sub> | **32**<br><sub>今日 +8</sub> | **11 天**<br><sub>上线于 2026-09-12</sub> |

#### 📊 业务转化与平台偏好
- **🎵 平台解析份额：** QQ 音乐 **55%** (64 次) ｜ 网易云音乐 **21%** (25 次) ｜ 酷狗音乐 **21%** (24 次) ｜ 汽水音乐 **3%** (4 次)
- **📦 导出格式偏好：** Excel 表格 (.xlsx) **47%** ｜ TXT 纯文本 **16%** ｜ CSV 表格 **19%** ｜ JSON 数据 **19%**
...
访问次数：**537** ｜ 不重复访客：**138**（近 14 天） ｜ 仓库克隆：**2,080** ｜ 不重复克隆：**393**（近 14 天）
...
> 数据开始：2026-09-07 · 最后更新：2026-09-22
<!-- INSIGHTS:END -->
