...
| :---: | :---: | :---: | :---: | :---: | :---: |
| **49**<br><sub>今日独立 +7</sub> | **140**<br><sub>今日 +15</sub> | **67**<br><sub>今日 +12</sub> | **15,314**<br><sub>今日 +4,256</sub> | **17**<br><sub>今日 +4</sub> | **10 天**<br><sub>上线于 2026-09-12</sub> |

#### 📊 业务转化与平台偏好
- **🎵 平台解析份额：** QQ 音乐 **55%** (37 次) ｜ 网易云音乐 **19%** (13 次) ｜ 酷狗音乐 **21%** (14 次) ｜ 汽水音乐 **4%** (3 次)
- **📦 导出格式偏好：** Excel 表格 (.xlsx) **29%** ｜ TXT 纯文本 **24%** ｜ CSV 表格 **24%** ｜ JSON 数据 **24%**
...
访问次数：**522** ｜ 不重复访客：**142**（近 14 天） ｜ 仓库克隆：**2,018** ｜ 不重复克隆：**391**（近 14 天）
...
> 数据开始：2026-09-07 · 最后更新：2026-09-21
<!-- INSIGHTS:END -->
