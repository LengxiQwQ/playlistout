...
> 💡 **完整数据字典与格式规范说明**：为了保持自述文件简洁，JSON 格式所有的富文本字段（如 `artistList`, `rawIds`, `totalDurationMs` 等 30+ 维度的底层元数据）的具体解释与类型定义，请查阅专用的详细解释文档：**[《JSON 数据格式规范 (Schema Document)》](./docs/JSON-SCHEMA.md)**。
...
| :---: | :---: | :---: | :---: | :---: | :---: |
| **163**<br><sub>今日独立 +5</sub> | **363**<br><sub>今日 +6</sub> | **353**<br><sub>今日 +3</sub> | **74,479**<br><sub>今日 +2,875</sub> | **78**<br><sub>今日 +0</sub> | **15 天**<br><sub>上线于 2026-09-12</sub> |

#### 📊 业务转化与平台偏好
- **🎵 平台解析份额：** QQ 音乐 **71%** (249 次) ｜ 网易云音乐 **15%** (53 次) ｜ 酷狗音乐 **12%** (44 次) ｜ 汽水音乐 **2%** (7 次)
...
> 数据开始：2026-09-07 · 最后更新：2026-09-26
<!-- INSIGHTS:END -->
